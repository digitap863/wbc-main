...
function ProjectOverview({img}) {
  return (
    ...
    <div className='md:w-1/2 px-8 mt-9 md:-mt-5 md:px-0'>
        ...
        <p className='font-mont text-slate-500 md:text-base text-sm font-semibold lg:w-[480px]'>Lorem ipsum dolor sit amet consectetur. Congue eu arcu neque um semper. Eros suspendisse varius enim ultrices  isque et quis ctumst. Feugiat amet velit faucibus amet</p>
        <br />
        <p className='font-mont text-slate-500 md:text-base text-sm font-semibold lg:w-[480px]'>Eu feugiat adipiscing viverrfeugiat. Mollis tellus malesuada massa amet lacinia aliquamid ultrices vitae.</p>
    </div>
