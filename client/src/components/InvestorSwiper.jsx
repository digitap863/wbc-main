                    ...
                    <SwiperSlide>
                        <div className='  bg-[#21094a50] p-3 border border-purple-500 rounded-lg flex flex-col rounded-br-[90px]'>
                            ...
                            <div className='relative group flex justify-center my-4'>
                                <div className="absolute justify-center flex left-1/4 right-1/4 inset-0.5 bg-gradient-to-r from-pink-600  to-purple-600 rounded-lg blurOpacity-75 group-hoverOpacity-100 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
