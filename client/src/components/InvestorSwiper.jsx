...
function InvestorSwiper() {
    ...
    function investoretails(data) {
        navigate('/investor-details',{state:data})
    }
    function fetchInvestors() {
        getdata('/get-investors').then((res) => {
        ...
        <div className='lg:mx-16 mt-20 flex flex-col items-center '>
            ...
            <div className='w-full md:px-10 px-3 mt-7'>
                ...
                >
                    {Investors.map((elem) => (
                        <SwiperSlide >
                            <div onClick={()=>investoretails(elem)} className='  bg-[#21094a50] p-3 border md:mx-0 mx-8 border-[#15bffd] rounded-lg flex flex-col'>
                                ...
                                <div className='relative group flex justify-center my-4'>
                                    <div className='bg-[#080B2A] relative flex justify-center'>
                                        ...
                                        <img src={`https://seefwbc.com/api/investorImages/${elem.profileImage}`} alt="" className='md:w-56 object-cover h-60 md:h-60 w-40 rounded-lg bg-[#21094a] relative' />
                                    </div>
                                </div>
                                <div className='flex justify-between'>
                                    <div className='ml-2'>
                                        <p className='font-zen text-white md:text-base text-xs'>{elem.fullName}</p>
                                        <p className='font-mont text-slate-400 font font-semibold text-xs mt-1 flex'><span><img className='w-5 mr-2' src={icon} alt="" /></span>{elem.city}</p>
                                    </div>
