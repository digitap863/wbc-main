...
function CoreTeam() {
    return (
        <div className='md:mx-32 flex flex-col items-center'>
            ...
            <p className='font-mont text-slate-300 w-[500px] mb-7 text-center text-xs font font-semibold'>With help from our teams, contributors and investors these are the milestones we are looking forward to achieve.</p>
            <div className='flex'>
                <div className='relative group md:mx-3'>
                    ...
                    <div className='relative flex  bg-[#080B2A] flex-col rounded-lg'>
