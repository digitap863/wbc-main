...
function ProjectsComponent() {
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-20'>
        <h1 className='text-white font-zen text-3xl'>Our Projects <span className='text-blue-500'>Coming Soon</span></h1>       
        <div className='mt-12 grid grid-cols-3 '>
            {projects.map((elem)=>(
            <div className='relative mx-4 my-7'>
                <div className='absolute bg-gradient-to-b from-[#080B2A] to-pink-500 -inset-[3px] rounded-xl'></div>
