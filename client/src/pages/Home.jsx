...
function Home() {
  return (
    <div>
      ...
      <Slider />
      <AboutF />
      <div className='relative group mx-16 mt-10'>
        <div className="absolute -inset-1 bg-gradient-to-r from-[#080B2A]  to-purple-600 rounded-lg opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
        <div className='relative flex  bg-[#080B2A] p-5 m- rounded-lg'>
          ...
          <div className='relative w-[60%] items-center flex ml-20'>
            <div className='border p-6 border-gray-700 rounded '>
              <p className='font-zen text-4xl bg-gradient-to-r from-purple-500 to-pink-500  text-transparent bg-clip-text'>INR 10,00,00,000 /-</p>
            </div>
          </div>
        </div>
      </div>
